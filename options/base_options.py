...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataroot', type=str, default='default', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        self.parser.add_argument('--which_model_netD', type=str, default='no_norm_4', help='selects model to use for netD')
        self.parser.add_argument('--which_model_netG', type=str, default='sid_unet_resize', help='selects model to use for netG')
        self.parser.add_argument('--which_model_netD_fea', type=str, default='fea_no_norm_4',help='selects model to use for netD_fea')
        self.parser.add_argument('--mirror', type=int, default=0,help='A is similiar to A1')
        self.parser.add_argument('--cali', type=int, default=0, help='CalibrateNetwork')
        self.parser.add_argument('--fea', type=int, default=0, help='ues feature netD')
        self.parser.add_argument('--colorD', type=int, default=0, help='ues color netD')
        self.parser.add_argument('--no_dropout', type=int, default=1, help='only used if which_model_netD==n_layers')
        ...
        self.parser.add_argument('--model', type=str, default='single', help='chooses which model to use. cycle_gan, pix2pix, test')
        ...
        self.parser.add_argument('--vgg_choose', type=str, default='relu4_3', help='choose layer for vgg')
        ...
        self.parser.add_argument('--self_attention', type=float, default=1, help='adding attention on the input of generator')
        self.parser.add_argument('--grad_attention', type=float, default=0,
                                 help='adding gradattention on the input of generator')
        self.parser.add_argument('--times_residual', type=float, default=1, help='output = input + residual*attention')
