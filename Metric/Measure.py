...
if __name__ == "__main__":
    ...
    parser.add_argument('-dirA', default='D:\\File\\lowlight\\test\\high', type=str)
    parser.add_argument('-dirB', default='D:\\File\\lowlight\\test\\test', type=str)
    # parser.add_argument('-dirA', default='E:\\lowlight_dataset\\SICE_Reshape', type=str)
    # parser.add_argument('-dirB', default='D:\\File\\lowlight\\python\\hap_run\\ablation\\lr_net1_11_gammavgg_relu4_3_SELU_2DA_2fea_ls_1g1d_mirror1\\SICE_Grad\\images', type=str)
    # parser.add_argument('-dirA', default='D:\\File\\lowlight\\python\\hap_run\\ablation\\lr_net1_11_gammavgg_relu4_3_SELU_2DA_2fea_ls_1g1d_mirror1_20241121\\VE-LOL-L-Cap-Low_test\\images', type=str)
    # parser.add_argument('-dirB', default='E:\\lowlight_dataset\\VE-LOL-L\\VE-LOL-L-Cap-Full\\VE-LOL-L-Cap-Normal_test', type=str)
    # parser.add_argument('-dirA', default="E:\\results\\PairLIE\\LSRW_Eval\\Huawei", type=str)
    # parser.add_argument('-dirB', default='E:\\lowlight_dataset\\LSRW_Eval\\Huawei\\high', type=str)

    # engan RetinexNet MBLLEN kind zero_dce zero_dce++ sci ruas LLFlow SGZ SNR_Net retinexformer URetinex zeroIG PIE PairLIE

    # parser.add_argument('-dirB', default='D:\\File\\lowlight\\python\\KinD\\results\\LOLdataset_eval15', type=str)   E:\results\engan\SICE_Grad
    parser.add_argument('-type', default=['png', 'jpg', 'jpeg', 'PNG','JPEG','JPEG'], type=str)
