...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_dir1', type=str,
                        default='E:\\lowlight_dataset\\LOLdataset\\eval15\\high\\',
                        help='directory for clean images')
    # engan zero_dce zero_dce++ RetinexNet MBLLEN kind sci ruas LLFlow SGZ SNR_Net retinexformer URetinex
    parser.add_argument('--test_dir2', type=str,
                        default='E:\\results\\MBLLEN\\lol\\',
